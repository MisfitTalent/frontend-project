...
export const ReportProvider = ({ children, }: Readonly<{
    ...
    return (<ReportStateContext.Provider value={state}>
      <ReportActionContext.Provider value={{
